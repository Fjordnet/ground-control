...
/**
 * Test class containing all Ground Control annotations.
 */
public class AllGroundControlAnnotations extends FragmentActivity {

    @NeedsPermission(BODY_SENSORS)
    public void initSensors() {
    }

    @OnPermissionDenied(BODY_SENSORS)
