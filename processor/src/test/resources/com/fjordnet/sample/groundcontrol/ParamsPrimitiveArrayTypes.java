 ...
 * with parameters of primitive array types only.
 */
public class ParamsPrimitiveArrayTypes extends Fragment {

    @NeedsPermission(RECORD_AUDIO)
    protected void startRecording(byte[] tag, long[] segments, boolean[] highQuality) {
    }
}
