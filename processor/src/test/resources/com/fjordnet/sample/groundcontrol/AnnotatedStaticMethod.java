...
/**
 * Class containing static methods annotated with Ground Control annotations.
 */
public class AnnotatedStaticMethod extends Fragment {

    @NeedsPermission(RECORD_AUDIO)
    public static void recordVoicemail() {
    }

    @OnPermissionDenied(RECORD_AUDIO)
    public static void onRecordFailed() {
    }

    @OnShowRationale(RECORD_AUDIO)
    public static void showRecordRationale(OnRationaleAcknowledgedListener listener) {
    }
}
