 ...
 */
public class DeniedUnmatchedPermissionsWarningsSuppressed extends Activity {

    @OnPermissionDenied(value = READ_CONTACTS, usageWarnings = false)
    public void onReadContactsPermissionDenied() {
    }

    @OnPermissionDenied(value = {READ_SMS, SEND_SMS, RECEIVE_SMS, RECEIVE_MMS},
            usageWarnings = false)
    ...
    @OnPermissionDenied(value = {ACCESS_COARSE_LOCATION, ACCESS_FINE_LOCATION},
            usageWarnings = false)
