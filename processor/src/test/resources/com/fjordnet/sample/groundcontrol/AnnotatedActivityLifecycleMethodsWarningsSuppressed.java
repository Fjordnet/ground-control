 ...
 * {@link NeedsPermission} with usage warnings turned off.
 */
public class AnnotatedActivityLifecycleMethodsWarningsSuppressed
        extends DuplicatePermissionsEquality {

    @Override
    @NeedsPermission(value = WRITE_EXTERNAL_STORAGE, usageWarnings = false)
